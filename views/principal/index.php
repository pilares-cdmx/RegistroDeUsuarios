...
<div class="sidebar-widget-area" id="pilares1">
  ...
  <div class="widget-content text-justify">
    <p>Los PILARES son Puntos de Innovación, Arte, Libertad, Educación y Saberes. Son espacios en donde toda la comunidad tiene acceso a la educación, a la capacitación y al desarrollo, en los barrios, colonias y pueblos que padecen más marginación
      y violencia.</p>
  </div>
</div>
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-6 wow fadeInUpBig scroll-class">
                    ...
                    <div class="single-blog-post post-style-2 d-flex align-items-center wow fadeInUpBig" data-wow-delay="0.2s">
                      <!-- Post Thumbnail -->
                      <div class="post-thumbnail">
                        <img src="img/blog-img/b10.jpg" alt="Actividades Cultura">
                      </div>
                      <!-- Post Content -->
                      <div class="post-content">
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse">
                                  <div class="panel-body">
                                    <div class="float-left img-modal">
                                      <img src="img/blog-img/b10.jpg" alt="Imagen de actividad">
                                    </div>
                                  </div>
                            ...
                            <div class="row-fluid">
                              <div class="panel panel-primary">
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse">
                                  <div class="panel-body">
                                    <div class="float-left img-modal">
                                      <img src="img/blog-img/b11.jpg" alt="Imagen de actividad">
                                    </div>
                                  </div>
                                  <div class="panel-body text-justify">
                                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3
                    ...
                    <div class="world-catagory-slider owl-carousel wow fadeInUpBig" data-wow-delay="0.1s">
                      ...
                      <div class="single-blog-post">
                        ...
                        <div class="post-thumbnail">
                          <img src="img/blog-img/b1.jpg" alt="">
                          <!-- Catagory -->
                          <div class="post-cta"><a href="#">Deportes</a></div>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                          <a href="#" class="headline">
      ...
      <div class="col-12 col-md-8 col-lg-4">
        <div class="post-sidebar-area wow fadeInUpBig" data-wow-delay="0.2s">
          ...
          <div class="sidebar-widget-area" id="pilares">
            <h5 class="title">¿Qué es PILARES?</h5>
            <div class="widget-content text-justify">
              <p>Los PILARES son Puntos de Innovación, Arte, Libertad, Educación y Saberes. Son espacios en donde toda la comunidad tiene acceso a la educación, a la capacitación y al desarrollo, en los barrios, colonias y pueblos que padecen más
                marginación y violencia.</p>
            </div>
          </div>
          <!-- Widget Area -->
            ...
            <div class="widget-content ">
              ...
              <div class="single-blog-post todays-pick " data-google-image-layout data-max-height="350">
                ...
                <div class="post-thumbnail m-p-g__thumbs">
                  <img src="img/blog-img/b22.jpg" data-full="img/blog-img/b22.jpg" alt="" class="m-p-g__thumbs-img">
...
<!--Footer -->
<footer class="page-footer font-small mdb-color unique-color pt-4">
  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row text-center text-md-left mt-3 pb-3">
      ...
      <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
        <h6 class="text-uppercase mb-4 font-weight-bold footer-text">PILARES</h6>
        <p class="justify footer-text">Los PILARES son Puntos de Innovación, Arte, Libertad, Educación y Saberes. Son espacios en donde toda la comunidad tiene acceso a la educación, a la capacitación y al desarrollo, en los barrios, colonias y
          pueblos que padecen más marginación y violencia.</p>
      </div>
      ...
      <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
        <h6 class="text-uppercase mb-4 font-weight-bold footer-text">Servicios</h6>
        <p>
          <a href="#!">Lorem Lorem ipsum dolor sit amet.</a>
        </p>
        <p>
          <a href="#!">Lorem Lorem ipsum dolor sit.</a>
        </p>
        <p>
          <a href="#!">Lorem Lorem ipsum dolor sit.</a>
        </p>
      ...
      <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
        <h6 class="text-uppercase mb-4 font-weight-bold footer-text">Links</h6>
        <p>
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
        <h6 class="text-uppercase mb-4 font-weight-bold footer-text">Contacto</h6>
        <p class="justify footer-text">
          <i class="fa fa-home mr-3"></i>Avenida Chapultepec 49
          Colonia Centro, Alcaldía Cuauhtémoc C.P. 06010, Ciudad de México </p>
        <p class="footer-text">
          <i class="fa fa-envelope mr-3"></i> info@gmail.com</p>
        <p class="footer-text">
          <i class="fa fa-phone mr-3"></i> + 01 (55) 55 55 55 55</p>
        <p class="footer-text">
          <i class="fa fa-print mr-3"></i> + 01 (55) 55 55 55 55</p>
      </div>
    ...
    <div class="row d-flex align-items-center mt-3">
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <!--Copyright-->
        <p class="text-center text-md-left footer-text">© 2019 Copyright:
          <a href="https://mdbootstrap.com/education/bootstrap/">
            <strong> Pilares.com</strong>
          </a>
        </p>
        ...
        <div class="text-center text-md-right footer-social">
          <ul class="list-unstyled list-inline">
            <li class="list-inline-item">
              <a class="btn-floating btn-sm rgba-white-slight mx-1" href="https://www.facebook.com/Pilares-CDMX-325332928095841/" target="_blank">
                <i class="fa fa-facebook"></i>
              </a>
            </li>
            <li class="list-inline-item">
              <a class="btn-floating btn-sm rgba-white-slight mx-1" href="https://twitter.com/CdmxPilares?s=08" target="_blank">
                <i class="fa fa-twitter"></i>
              </a>
            </li>
            <li class="list-inline-item">
              <a class="btn-floating btn-sm rgba-white-slight mx-1" href="https://www.instagram.com/pilarescdmx/?utm_source=ig_profile_share&igshid=u462xj96zovt" target="_blank">
