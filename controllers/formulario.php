...
class Formulario extends Controller
{
     ...
     */
    public function listarAlcaldias()
    {
    ...
    public function registrarUsuario()
    {
         ...
         */
            ...
            $gradoEstudios=(!is_null($_POST['grado'])) ? $_POST['grado'] : "Sin Datos";
            ...
            $tiempoResidencia=(!is_null($_POST['timepoResidencia'])) ? $_POST['timepoResidencia'] : 0;
            ...
            $fechaRegistro = $dateTime->format('U = Y-m-d');
