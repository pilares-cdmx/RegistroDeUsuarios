$(document).ready(function()
	{
		...
		$('#municipio').append("<option value='0'>Selecciona CodigoPostal...</option>");
		...
		comboPaises.append("<option value='0'>Cargando Alcalidas...</option>");
		$.getJSON("cargarcombos.php",{bandera:"1",filtro:""},function(objetosretorna){
			comboPaises.empty();
			comboPaises.append("<option value='0'>Seleccion Alcaldia...</option>");
		...
		$("#pais").change(function(){
			...
			if(Pais==0){
				...
				$.getJSON("cargarcombos.php",{bandera:"2", filtro: $("#pais").val()},function(objetosretorna){
					$("#estados").empty();
					$("#estados").append("<option value='0'>Selecciona Estado...</option>");
